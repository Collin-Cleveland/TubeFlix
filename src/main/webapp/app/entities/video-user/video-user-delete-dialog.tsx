...
import { getEntity, deleteEntity } from './video-user.reducer';
...
export const VideoUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupProjectApp.videoUser.delete.question">
        <Translate contentKey="groupProjectApp.videoUser.delete.question" interpolate={{ id: videoUserEntity.id }}>
