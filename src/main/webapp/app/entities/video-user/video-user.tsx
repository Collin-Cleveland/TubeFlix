  ...
  return (
    <div>
      <h2 id="video-user-heading" data-cy="VideoUserHeading">
        <Translate contentKey="groupProjectApp.videoUser.home.title">Video Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="groupProjectApp.videoUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/video-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="groupProjectApp.videoUser.home.createLabel">Create new Video User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {videoUserList && videoUserList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="groupProjectApp.videoUser.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="groupProjectApp.videoUser.home.notFound">No Video Users found</Translate>
            </div>
          )
        )}
      </div>
